 ...
 <style>
  ...
  <main id="main-container">
                            ...
                            <div class="row my-1">
                                <div class="col-xl-6">
                                    <input type="text" class="js-flatpickr form-control" name="date"
                                        placeholder="F j, Y" data-alt-input="true" data-date-format="d F Y"
                                        id="formatDate" value="{{ date('d F Y', strtotime($formatDate)) }}">
                                </div>
                                <div class="col-xl-3">
                    ...
                    <div class="modal-content">
                        <div class="block block-rounded block-transparent mb-0">
                           ...
                           <form id="ItemForm" action="javascript:void(0)" method="POST" enctype="multipart/form-data">
                            ...
                            <label class="text-center" for="status">{{ __('part_s.cancel_order') }}</label>
   ...
   <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    $('#order-table').DataTable().column(2).search(filterDate).draw();
});
