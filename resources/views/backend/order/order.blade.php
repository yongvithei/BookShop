                ...
                <div class="col-lg-12">
                    ...
                    <div class="block block-rounded">
                        <ul class="nav nav-tabs nav-tabs-block align-items-center" role="tablist">
                            <li class="nav-item">
                                <button class="nav-link active" id="btabswo-order-tab" data-bs-toggle="tab" data-bs-target="#btabswo-order" role="tab" aria-controls="btabswo-static-home" aria-selected="true">All Order</button>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="block-content tab-content">
                            <div class="tab-pane active" id="btabswo-order" role="tabpanel" aria-labelledby="btabswo-order-tab" tabindex="0">
                                <!-- Dynamic Table Full -->
                                <div class="block block-rounded">
                                    <div class="tab-pane">
