                        ...
                        <div class="row">
                            <div class="col-12 col-xl-8">
                                <div class="shop-cart-list mb-3 p-3">
                                    ...
                                    <div class="d-lg-flex align-items-center gap-2">	<a href="javascript:;" class="btn btn-dark btn-ecomm">
                            ...
                            <div class="col-12 col-xl-4">
                                <div class="checkout-form p-3 bg-light">
                                    <div class="card rounded-0 border bg-transparent shadow-none">
                                        <div class="card-body">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <button class="btn bg-dark btn-ecomm text-white" type="button">Apply Discount</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card rounded-0 border bg-transparent mb-0 shadow-none">
                                        <div class="card-body">
                                            <p class="mb-2">{{ __('main.subtotal') }}: <span class="float-end">$198.00</span></p>
                                            <p class="mb-2">{{ __('main.shipping') }}: <span class="float-end">--</span></p>
                                            <p class="mb-2">{{ __('main.taxes') }}: <span class="float-end">$14.00</span></p>
                                            <p class="mb-0">{{ __('main.discount') }}: <span class="float-end">--</span></p>
                                            <div class="my-3 border-top"></div>
                                            <h5 class="mb-0">{{ __('main.order_total') }}: <span class="float-end">$212.00</span></h5>
                                            <div class="my-4"></div>
                                            <div class="d-grid">
                                                <a href="javascript:;" class="btn btn-dark btn-ecomm">{{ __('main.proceed_to_checkout') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
